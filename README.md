...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-v1.5.0--beta.2-blue" alt="v1.5.0-beta.2">
  <img src="https://img.shields.io/badge/python-3.12%2B-3776AB" alt="Python 3.12+">
</p>

> [!WARNING]
> `v1.5.0-beta.2` là live-update gate cho Linux x64, đồng thời sửa mở thư mục trên Linux và chuẩn hóa cuộn dọc cho OptiFine/Instance Info ở màn hình nhỏ.
...
| Nền tảng | Trạng thái Beta 2 | Ghi chú |
| --- | --- | --- |
| Windows 10/11 x64 | Đang hỗ trợ | Luồng chính và bản đóng gói PyInstaller hiện tại. |
| Linux x64 | Beta test target | Kiểm tra trực tiếp automatic update Beta 1 → Beta 2, mở thư mục và responsive UI. |
...
GitHub Release Actions chỉ build ZIP native Windows/Linux sau khi test cả hai nền tảng đạt. Beta 2 chưa cung cấp AppImage hoặc `.deb`; updater Linux hoạt động với ZIP `linux-x64` đặt trong thư mục người dùng có quyền ghi.
...
- [Release notes v1.5.0-beta.2](docs/releases/v1.5.0-beta.2.md)
