...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-v1.5.0--beta.3-blue" alt="v1.5.0-beta.3">
  <img src="https://img.shields.io/badge/python-3.12%2B-3776AB" alt="Python 3.12+">
</p>

> [!WARNING]
> `v1.5.0-beta.3` hoàn thiện dialog OptiFine mở từ panel chức năng của instance. Live update Beta 1 → Beta 2 trên Linux x64 đã được xác nhận hoạt động thành công.
...
| Nền tảng | Trạng thái Beta 3 | Ghi chú |
| --- | --- | --- |
| Windows 10/11 x64 | Đang hỗ trợ | Luồng chính và bản đóng gói PyInstaller hiện tại. |
| Linux x64 | Beta test target | Automatic update Beta 1 → Beta 2 đã đạt; Beta 3 chốt responsive UI của OptiFine và regression desktop. |
...
GitHub Release Actions chỉ build ZIP native Windows/Linux sau khi test cả hai nền tảng đạt. Beta 3 chưa cung cấp AppImage hoặc `.deb`; updater Linux hoạt động với ZIP `linux-x64` đặt trong thư mục người dùng có quyền ghi.
...
- [Release notes v1.5.0-beta.3](docs/releases/v1.5.0-beta.3.md)
