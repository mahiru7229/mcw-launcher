...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-v1.5.0--alpha.4-orange" alt="v1.5.0-alpha.4">
  <img src="https://img.shields.io/badge/python-3.12%2B-3776AB" alt="Python 3.12+">
</p>

> [!WARNING]
> `v1.5.0-alpha.4` là bản thử nghiệm đa nền tảng chạy từ source. Vanilla, Microsoft login, Fabric và Quilt đã vượt qua kiểm thử Lubuntu; Forge/NeoForge, nhiều managed Java runtime và responsive UI toàn diện là release gate của Alpha 4.
...
| Nền tảng | Trạng thái Alpha 4 | Ghi chú |
| --- | --- | --- |
| Windows 10/11 x64 | Đang hỗ trợ | Luồng chính và bản đóng gói PyInstaller hiện tại. |
| Linux x64 | Alpha 4 test target | Vanilla, Microsoft, Fabric và Quilt đã được xác nhận trên Lubuntu 24.04/VirtualBox; Alpha 4 đưa Forge/NeoForge và multi-Java vào release gate. |
...
Alpha 4 cung cấp source để test Linux, chưa cung cấp AppImage hoặc `.deb`. Không nên dùng script Windows hoặc đổi đuôi artifact để giả lập Linux release.
...
- [Release notes v1.5.0-alpha.4](docs/releases/v1.5.0-alpha.4.md)
