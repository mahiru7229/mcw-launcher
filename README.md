...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-v1.5.0--alpha.3-orange" alt="v1.5.0-alpha.3">
  <img src="https://img.shields.io/badge/python-3.12%2B-3776AB" alt="Python 3.12+">
</p>

> [!WARNING]
> `v1.5.0-alpha.3` là bản thử nghiệm đa nền tảng chạy từ source. Vanilla Minecraft đã được smoke-test thành công trên Lubuntu; Microsoft login, Fabric và Quilt là release gate mới cần được xác nhận trên máy thử nghiệm. Hãy giữ bản sao dữ liệu Alpha 2 cho đến khi migration hoàn tất.
...
| Nền tảng | Trạng thái Alpha 3 | Ghi chú |
| --- | --- | --- |
| Windows 10/11 x64 | Đang hỗ trợ | Luồng chính và bản đóng gói PyInstaller hiện tại. |
| Linux x64 | Alpha 3 test target | Vanilla 1.21.1 đã được xác nhận trên Lubuntu 24.04/VirtualBox; Alpha 3 bổ sung XDG, Secret Service, Microsoft OAuth, Fabric/Quilt và process groups. |
...
Alpha 3 cung cấp source để test Linux, chưa cung cấp AppImage hoặc `.deb`. Không nên dùng script Windows hoặc đổi đuôi artifact để giả lập Linux release.
...
- [Release notes v1.5.0-alpha.3](docs/releases/v1.5.0-alpha.3.md)
