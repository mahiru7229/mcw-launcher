...
class GuiSettingsController(BaseController):
    ...
    def load(self) -> dict:
        ...
        self._current = {
            ...
            "discord_rpc_enabled": bool(launch.get("discord_rpc_enabled", self.DEFAULTS["discord_rpc_enabled"])),
            "discord_client_id": str(launch.get("discord_client_id", self.DEFAULTS["discord_client_id"])),
            "minimize_on_launch": bool(launch.get("minimize_on_launch", self.DEFAULTS["minimize_on_launch"])),
    ...
    def save(self, data: dict) -> None:
        ...
        self._current = {
            ...
            "discord_rpc_enabled": bool(data.get("discord_rpc_enabled", self.DEFAULTS["discord_rpc_enabled"])),
            "discord_client_id": str(data.get("discord_client_id", self.DEFAULTS["discord_client_id"])).strip(),
            "minimize_on_launch": bool(data.get("minimize_on_launch", self.DEFAULTS["minimize_on_launch"])),
        ...
        self._settings.save({
            ...
            "launch": {
                ...
                "prefer_dedicated_gpu": self._current["prefer_dedicated_gpu"],
                "discord_rpc_enabled": self._current["discord_rpc_enabled"],
                "discord_client_id": self._current["discord_client_id"],
                "minimize_on_launch": self._current["minimize_on_launch"],
            },
            "updates": {
