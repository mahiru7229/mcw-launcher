...
class LauncherSettingsPage(BasePage):
    ...
    def _build_ui(self) -> None:
        ...
        self.unused_version_retention_label = QLabel(tr("storage.legacy.jar_retention.label"))
        self.unused_version_retention_days = QSpinBox()
        self.unused_version_retention_days.setRange(1, 365)
        self.unused_version_retention_days.setValue(14)
        self.unused_version_retention_days.setSuffix(tr("storage.legacy.jar_retention.suffix"))
        self.unused_version_retention_days.setToolTip(tr("storage.legacy.jar_retention.tooltip"))
        retention_row = QHBoxLayout()
        retention_row.addWidget(self.unused_version_retention_label)
        retention_row.addStretch(1)
        retention_row.addWidget(self.unused_version_retention_days)
        ...
        self.storage_cleanup_card.layout.addLayout(retention_row)
    ...
    def _connect_dirty_tracking(self) -> None:
        ...
        self.unused_version_retention_days.valueChanged.connect(self._refresh_dirty_state)
    ...
    def form_data(self) -> dict:
        return {
            ...
            "unused_version_retention_days": self.unused_version_retention_days.value(),
    ...
    def retranslate_dynamic(self) -> None:
        ...
        self.unused_version_retention_label.setText(tr("storage.legacy.jar_retention.label"))
        self.unused_version_retention_days.setSuffix(tr("storage.legacy.jar_retention.suffix"))
        self.unused_version_retention_days.setToolTip(tr("storage.legacy.jar_retention.tooltip"))
    ...
    def _apply_form_data(self, settings: dict) -> None:
        persisted_controls = (
            ...
            self.unused_version_retention_days,
        ...
        self.unused_version_retention_days.setValue(max(1, min(int(settings.get("unused_version_retention_days", 14) or 14), 365)))
