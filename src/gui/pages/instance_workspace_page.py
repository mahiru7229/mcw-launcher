...
class InstanceWorkspacePage(BasePage):
    ...
    browse_atlauncher_modpacks_requested = Signal()
    ...
    def _build_ui(self) -> None:
        ...
        self.browse_atlauncher_modpacks_button = set_theme_icon(QPushButton(), "icon.action.download")
        ...
        self.browse_atlauncher_modpacks_button.clicked.connect(self.browse_atlauncher_modpacks_requested.emit)
        ...
        toolbar_layout.addWidget(self.browse_atlauncher_modpacks_button)
    ...
    def _connect_dialogs(self) -> None:
        ...
        self.create_dialog.reload_loader_requested.connect(self.reload_loader_requested.emit)
        ...
        self.create_dialog.browse_atlauncher_requested.connect(self.browse_atlauncher_modpacks_requested.emit)
    ...
    def retranslate_dynamic(self) -> None:
        ...
        self.browse_atlauncher_modpacks_button.setText(tr("workspace.toolbar.atlauncher"))
