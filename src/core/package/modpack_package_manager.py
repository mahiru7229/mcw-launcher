...
class ModpackPackageManager:
    ...
    def _portable_override_files(instance: Instance, include_saves: bool) -> list[tuple[Path, str]]:
        ...
        ignored_mcw = {"mod-provenance.json", "modrinth.json", "curseforge.json", "modrinth-pack.json", "curseforge-pack.json", "ftb-pack.json", "atlauncher-pack.json", "content-library.json", "manual-files.json", "portable-disabled-files.json", "portable-referenced-files.json"}
