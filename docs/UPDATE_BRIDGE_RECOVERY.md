...
`MCW Update Bridge 1.3.0` is a standalone recovery executable for **Windows x64 and Linux x64**. Its default target is `v1.5.1-beta.4`.
...
3. Read the official GitHub release metadata for `v1.5.1-beta.4`.
