...
Tài liệu này mô tả ranh giới kiến trúc áp dụng từ `v1.5.0-beta.3`. Mục tiêu là giảm phụ thuộc chéo, giữ startup không bị network I/O ngầm và chuẩn bị implementation đa nền tảng.
