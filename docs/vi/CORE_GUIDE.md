...
Dependency contract của Core độc lập sẽ được chốt ở đợt release riêng. Implementation Core không phụ thuộc GUI, dù môi trường phát triển launcher hiện cài PySide6.
