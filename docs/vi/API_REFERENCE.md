...
> Snapshot từ thời 1.0.1 được giữ lại cho mục đích migration. Alpha 2 chưa phát hành Core độc lập; consumer hiện tại cần đối chiếu export trong `mcw_core` và `mcw_core.api`.
