...
The standalone Core dependency contract will be finalized with its separate release. The Core implementation remains GUI-independent even though the launcher development environment installs PySide6.
