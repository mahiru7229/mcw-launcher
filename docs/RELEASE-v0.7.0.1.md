# MCW Launcher v0.7.0.1

## Tiếng Việt

`v0.7.0.1` là bản vá Stable khẩn cấp cho luồng đăng nhập Offline khi chạy Minecraft Forge.
...
`v0.7.0.1` is an emergency Stable hotfix for the Offline account launch path on Minecraft Forge.
