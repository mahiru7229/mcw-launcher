...
Bundled runtime for MCW Launcher **v1.5.0-alpha.2**. Alpha 2 does not publish a standalone MCW Core source archive or wheel; that artifact will be prepared and verified in a separate release step.
